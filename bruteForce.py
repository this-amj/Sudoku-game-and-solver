...
'''
Shatha Almatrafi
Time Complexity will be referred to as TC
'''
...
def solveSudoku(grid, row, col): #TC = O(n^2)
    ''' the variable trials represents number of assumptions tested until correct configuration is found.
    we notice that the more cells entered as an input, the more trials are executed, since a higher number 
    of empty cells accordingly increases the chance of the validity of the number assigned. 
    '''
    global trials
    trials = 0
    trials = trials + 1
